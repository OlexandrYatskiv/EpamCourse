...
public class CrazyGenerics {
    ...
    static class CollectionUtil {
         ...
         * as second parameter.
         *
         * @paramentities            provided collection of entities
         * @paramvalidationPredicate criteria for validation
         * @return true if all entities fit validation criteria
         */
        public static boolean isValidCollection(Collection<BaseEntity> entities, Predicate<BaseEntity> validationPredicate) {
         ...
         */
        public  static <T>boolean hasDuplicates(Collection<BaseEntity> entities, BaseEntity targetEntity) {
